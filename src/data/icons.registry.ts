...
export const iconRegistry: Record<string, Icon> = {
  IconApps, IconArmchair, IconBabyCarriage, IconBarbell, IconBat,
  IconBolt, IconBowl, IconBrain, IconButterfly,
  ...
  IconCar, IconCarSuv, IconCash, IconCat, IconCategory, IconChartLine, IconCloud,
  IconCode, IconCoin, IconCreditCard, IconDental, IconDeviceLaptop,
  IconDeviceMobile, IconDog, IconDots, IconDroplet, IconFish, IconFlame,
  IconGasStation, IconGift, IconGlass, IconHeart, IconHeartbeat, IconHome,
  IconHorse, IconKey, IconMouse, IconMovie, IconPalette, IconParking, IconPaw,
  IconPig, IconPigMoney, IconPill, IconPlane, IconPlaneTilt, IconReceipt,
  IconReceiptTax, IconRobot, IconSchool, IconScissors, IconShield, IconShirt,
  IconShoppingBag, IconShoppingCart, IconSofa, IconStethoscope, IconTicket,
  IconTool, IconToolsKitchen2, IconToolsKitchen3, IconTruckDelivery, IconUser,
  IconUserPlus, IconUsers, IconWallet, IconWifi,
};
